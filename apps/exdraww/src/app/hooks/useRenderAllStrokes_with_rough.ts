...
export const useRenderAllStrokes = (
  ...
  }, [optimizedStrokes, ctxRef, canvasRef, stroke, drawRoughRectangle, drawRoughCircle, drawRoughArrow]);
  ...
  const renderPenStroke = useCallback((
    ...
    ctx.beginPath();
    ctx.arc(strokePoint.x, strokePoint.y, strokePoint.size / 2, 0, 2 * Math.PI);
